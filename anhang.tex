...
\subsection{Taxonomie} % (fold)
\label{sub:taxonomie}
\todo{„Zwangs–Tags“ für Beiträge, etc.}
% subsection taxonomie (end)

\subsection{Rollen und Rechte} % (fold)
\label{sub:rollen_und_rechte}
\todo{Tabelle mit Rollen und Rechten in Forum, Wiki \& Wissensbasis}
% subsection rollen_und_rechte (end)
