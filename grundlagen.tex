...
Die Hauptzielgruppe der Lernplattform sind die \buzz{Studierenden der Hochschule}. Die Studierenden bewegen sich frei im Lernstoff und wählen nach eigenen Vorlieben zwischen den CSCL–Werkzeugen. Ein besonderes Augenmerk sollte hier auf diejenigen Studierenden gelegt werden, die das jeweilige Modul bereits abgeschlossen haben, da von diesen zu erwarten ist, dass sie besonders wertvolle Beiträge und Lerntips im Diskussionsforum bereitstellen können.\footnote{siehe z.B. \url{Fernstudenten.de}}
